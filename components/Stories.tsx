...
const Stories: React.FC = () => {
  return (
    <section id="stories" className="py-24 bg-brand-navy">
      <div className="container mx-auto px-6">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 font-serif text-brand-baby">Success Stories</h2>
          <p className="text-brand-baby/70 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((story, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="bg-gradient-to-b from-brand-navy to-brand-grotto/10 p-8 rounded-2xl border border-brand-grotto/30 shadow-xl"
            >
              ...
              <p className="text-brand-baby mb-6 italic leading-relaxed text-lg">"{story.quote}"</p>
